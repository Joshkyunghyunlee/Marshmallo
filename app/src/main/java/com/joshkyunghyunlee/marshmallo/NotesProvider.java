...
public class NotesProvider extends ContentProvider {
    private static final String AUTHORITY = "com.joshkyunghyunlee.marshmallo.notesprovider";
    ...
    //DBOpenHelper.TABLE_NOTES is the database name
    @Override
    public boolean onCreate() {
        DBOpenHelper helper = new DBOpenHelper(getContext());
        database = helper.getWritableDatabase(); //should create database
        return true;
    }

    //Get data from the Database 'Notes'
    @Nullable
    @Override
